...
public class Sign_up4 extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        garageModel=FirebaseUtil.userGarageInfo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        launcher1=registerForActivityResult(contract, new ActivityResultCallback<Uri>() {
            @Override
            public void onActivityResult(Uri result) {
                if ((result!=null))
                {
        ...
        binding.imageID1Edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                launcher.launch(null);
            }
        });
        binding.imageID2Edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        validat();
            ...
            binding.checkSign4.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
